...
/** biome-ignore-all lint/complexity/noBannedTypes: <reason> */
...
export function controllerHandler<T>(fn: HttpController<any, any, T>) {
...
export function Controller() {
	return <T extends Constructor>(Target: T): T => {
		for (const key of Object.getOwnPropertyNames(Target)) {
			...
			const wrapped = wrapControllerMethod(original as StrictController);
