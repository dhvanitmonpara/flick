...
export const findByUserAndPostId = async (
	userId: string,
	postId: string,
	dbTx?: DB,
) => {
...
export const findByUserAndPostIdWithPost = async (
	userId: string,
	postId: string,
	dbTx?: DB,
) => {
...
export const deleteBookmarkByUserAndPostId = async (
	userId: string,
	postId: string,
	dbTx?: DB,
) => {
...
export const create = async (
	bookmark: typeof bookmarks.$inferInsert,
	dbTx?: DB,
) => {
	const client = dbTx ?? db;
...
export const findBookmarkedPostsByUserId = async (
	userId: string,
	dbTx?: DB,
) => {
	const client = dbTx ?? db;
