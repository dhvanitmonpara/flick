...
export default function ResetPasswordEmail({ url, projectName }: { url: string; projectName: string }) {
  return (
    <BaseLayout projectName={projectName}>
      <Section>
        <Text style={style.topText}>Reset your {projectName} password</Text>
        <Text>Someone recently requested a password change for your {projectName} account. If this was you, you can set a new password here:</Text>
