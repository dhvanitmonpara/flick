...
export async function getModerationConfigWords(): Promise<{ strictWords: string[]; normalWords: string[] }> {
...
export async function deleteBannedWord(id: string): Promise<BannedWordRecord | null> {
