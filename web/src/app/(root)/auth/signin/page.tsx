...
function SignInPage() {
  ...
  return (
    <>
      ...
      <Dialog
        open={!!noPasswordEmail}
        onOpenChange={(open) => {
          if (!open) setNoPasswordEmail(null);
        }}
      >
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              This account was created via Google Sign-In and doesn&apos;t have
              a password yet. Choose how you&apos;d like to log in:
            </DialogDescription>
          </DialogHeader>
          <div className="flex flex-col gap-3 pt-2">
            ...
            <Button
              ...
              onClick={() => {
                if (noPasswordEmail) {
                  navigate(
                    `/auth/login-otp/${encodeURIComponent(noPasswordEmail)}`,
                  );
                }
                setNoPasswordEmail(null);
              }}
            ...
            <p className="text-xs text-center text-zinc-500 dark:text-zinc-400 pt-1">
              ...
              <Link
                href={
                  noPasswordEmail
                    ? `/auth/password-recovery?email=${noPasswordEmail}`
