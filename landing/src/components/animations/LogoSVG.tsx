...
export default function App() {
  // We use a state key to force the SVG to re-mount and replay the animation
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] flex flex-col items-center justify-center p-8 font-sans">
      ...
      <div className="w-full max-w-4xl aspect-[16/9] relative flex items-center justify-center">
        ...
        >
          ...
          <g className="logo-group">
            {/* 'F' */}
            <path className="letter f-top" pathLength="100" d="M 110 230 C 180 190, 280 170, 390 150" />
            <path className="letter f-stem" pathLength="100" d="M 190 110 C 180 250, 160 380, 130 500" />
            <path className="letter f-mid" pathLength="100" d="M 110 340 C 150 330, 190 310, 230 290" />

            {/* 'l' */}
            <path className="letter l-stem" pathLength="100" d="M 430 150 C 410 280, 390 400, 380 450 C 378 460, 385 465, 395 455" />

            {/* 'i' */}
            <path className="letter i-stem" pathLength="100" d="M 500 250 C 480 330, 470 400, 460 440 C 458 450, 465 455, 475 445" />
            <path className="letter i-dot" pathLength="100" d="M 520 150 L 505 180" />

            {/* 'c' */}
            <path className="letter c-curve" pathLength="100" d="M 660 270 C 600 240, 550 290, 550 350 C 550 410, 610 430, 670 390" />

            {/* 'k' */}
            <path className="letter k-stem" pathLength="100" d="M 750 140 C 730 280, 710 400, 700 470" />
            <path className="letter k-top" pathLength="100" d="M 830 240 C 790 280, 750 310, 720 340" />
            <path className="letter k-bot" pathLength="100" d="M 720 340 C 760 410, 820 440, 900 410" />
          </g>
        </svg>
      </div>
    </div>
